<template>
        <footer class="flex flex-col items-center justify-between px-6 bg-orange-100 py-4 sm:flex-row">
            <a href="#" class="text-xl font-bold text-gray-800 hover:text-gray-700 ">Cheqd Network</a>
            <p class="py-2 text-gray-800 sm:py-0">&copy; {{ new Date().getFullYear() }} - All rights reserved</p>
            <div class="flex -mx-2">
                <a href="#" class="mx-2 text-gray-800 hover:text-gray-500 " aria-label="Reddit">
					<svg class="w-6 h-6 fill-current text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3333 3333" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"><path d="M1667 0c920 0 1667 746 1667 1667 0 920-746 1667-1667 1667C747 3334 0 2588 0 1667 0 747 746 0 1667 0zm-215 1336h342v175h5c48-86 164-175 338-175 361 0 428 225 428 517v596h-357v-528c0-126-3-288-186-288-186 0-214 137-214 279v537h-357V1336zm-247-309c0 102-83 186-186 186-102 0-186-83-186-186 0-102 83-186 186-186 102 0 186 83 186 186zm-371 309h371v1113H834V1336z"/></svg>
                </a>
                ...
                <a href="#" class="mx-2 text-gray-800 " aria-label="Github">
                    <svg class="w-6 h-6 fill-current text-gray-700" fill="none"
