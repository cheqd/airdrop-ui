        ...
        <footer class="w-full h-full">
			<div class="flex gap-4 items-center justify-center px-6 py-8 h-full flex-col">
				...
				<div class="flex flex-1 gap-2">
					...
					<a href="#" class="mx-2 text-gray-800 " aria-label="Twitter">
						<svg class="w-10 h-10 hover:text-cheqd-light-blue fill-current text-gray-200"
					...
					<a href="#" class="mx-2 text-gray-800 hover:text-gray-500 " aria-label="Reddit">
						<svg class="w-10 h-10 hover:text-cheqd-light-blue fill-current text-gray-100" viewBox="0 0 3333 3333" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"><path d="M1667 0c920 0 1667 746 1667 1667 0 920-746 1667-1667 1667C747 3334 0 2588 0 1667 0 747 746 0 1667 0zm-215 1336h342v175h5c48-86 164-175 338-175 361 0 428 225 428 517v596h-357v-528c0-126-3-288-186-288-186 0-214 137-214 279v537h-357V1336zm-247-309c0 102-83 186-186 186-102 0-186-83-186-186 0-102 83-186 186-186 102 0 186 83 186 186zm-371 309h371v1113H834V1336z"/></svg>
					</a>

					<a href="#" class="mx-2 text-gray-800 " aria-label="Github">
						<svg class="w-10 h-10 fill-current hover:text-cheqd-light-blue text-gray-200" fill="none"
							viewBox="0 0 48 48">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24ZM11.3912 15.234C11.6845 15.5046 11.8343 15.9019 11.7946 16.3039V30.779C11.8816 31.3011 11.7208 31.8345 11.3613 32.2158L8 36.3886V36.9389H17.5313V36.3886L14.1699 32.2158C13.8079 31.8351 13.6371 31.3053 13.7068 30.779V18.2604L22.0728 36.9389H23.0439L30.2297 18.2604V33.1481C30.2297 33.5456 30.2297 33.622 29.9757 33.8818L27.3912 36.4497V37H39.9402V36.4497L37.4454 33.943C37.2251 33.7712 37.1159 33.4888 37.1615 33.2093V14.7907C37.1159 14.5112 37.2251 14.2288 37.4454 14.057L40 11.5503V11H31.1559L24.8515 27.0952L17.6807 11H8.40336V11.5503L11.3912 15.234Z"/>
						</svg>
				...
				<div class="flex justify-center items-center gap-2 text-center">
					<span href="#" class="text-md text-gray-400">
